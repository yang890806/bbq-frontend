          ...
          <Col>
            <Link href="/" className="no-underline">
              <div className={styles.btn} style={{ width: "90px" }}>
                <FontAwesomeIcon
                  icon={faChevronLeft}
                  className="mr-2 mt-1 flex flex-row"
                />
                {t("Back")}
              </div>
            </Link>
          ...
          <Col className="flex flex-col justify-center">
            ...
            <Row>
              <Col className="h-24 overflow-y-scroll">
                ...
                middle school students. A student template for teachers to use
                introduce Book Creator to middle school students. A student
                template for teachers to use introduce Book Creator to middle
                school students. A student template for teachers to use
                introduce Book Creator to middle school students. A student
                template for teachers to use introduce Book Creator to middle
                school students. A student template for teachers to use
                introduce Book Creator to middle school students.
              </Col>
            </Row>
            <Row className="mt-12">
              <Col>
